          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr, index) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changeprice="0" :class="{ active: spuSaleAttrValue.isChecked == 1 }" 
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <button  class="plus" @click="addSkuNum">+</button>
                <button  class="mins" @click="minusSkuNum">-</button>
              </div>
              <div class="add">
...
export default {
  ...
  methods:{
    //产品售卖属性切换高亮
    changActive(spuSaleAttrValue,SaleAttrValueList){
